...
To address the issue of population bias, we decided to normalize handle by dividing it by the total number of households, creating the handle_per_household metric. This caused a significant shift in our model's performance metrics, as shown below:
