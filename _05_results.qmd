...
<figure id="fig-edu_ml">
  <img src="figures/figure4c.png" alt="edu_ml" width="800">
  <figcaption style="font-size: 8px; color: #555;">
...
<figure id="fig-income_ml1">
  <img src="figures/figure4a.png" alt="income_ml1" width="800">
  <figcaption style="font-size: 8px; color: #555;">
...
<figure id="fig-income_ml2">
  ...
  <figcaption style="font-size: 8px; color: #555;">
    Figure 4c: Confusion matrix showing logistic regression performance in classifying states by betting revenue per household.
  </figcaption>
</figure>
